...
## Project Structure
    ...
    ├── mickeys_magical_gui_30162  # Django project configurations
...
1. Clone this repo and `cd mickeys_magical_gui_30162`
...
2. Clone this repo and `cd mickeys_magical_gui_30162`
